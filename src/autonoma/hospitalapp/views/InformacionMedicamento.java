 ...
 * @version 1.0.0
 */
public class InformacionMedicamento extends javax.swing.JDialog {
    private SistemaCentral sistema;

    /**
     * Creates new form InformacionMedicamento
     */
    public InformacionMedicamento(javax.swing.JDialog parent, boolean modal,SistemaCentral sistema) {
        super(parent, modal);
        initComponents();
         setSize(620, 700);
        setResizable(false);
