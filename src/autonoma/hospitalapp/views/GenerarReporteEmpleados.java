...
public class GenerarReporteEmpleados extends javax.swing.JDialog {
    ...
    /**
     * Creates new form GenerarReporteEmpleados
     */
    public GenerarReporteEmpleados(JDialog parent, boolean modal, SistemaCentral sistema, Reporte reporte) throws IOException {
        super(parent, modal);
        initComponents();
        setSize(620, 700);
        setResizable(false);
    ...
    private void initComponents() {
        ...
        InformacionEmpleados = new javax.swing.JTextArea();
        ...
        InformacionEmpleados.setColumns(20);
        InformacionEmpleados.setRows(5);
        InformacionEmpleados.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
